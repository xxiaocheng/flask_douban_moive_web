...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["celebrity_id"], ["celebrities.id"], ondelete="CASCADE"
        ),
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "movie_id", "country_id", name="unique_movie_id_and_country_id"
        ),
    )
    op.create_table(
        "movie_directors",
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "movie_id", "genre_id", name="unique_movie_id_and_genre_id"
        ),
    )
    op.create_table(
        "users",
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "user_id", "rating_id", name="unique_user_id_and_rating_id"
        ),
    )
    op.create_table(
        "rating_reports",
