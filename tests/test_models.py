...
from app.sql_models import (User, Movie, Celebrity, Rating, Notification, Genre, Country, Tag)
...
class UserModelsTestCase(unittest.TestCase):
    ...
    def test_password_setter(self):
        """test
        """
        u = User.create_one(username=fake.name(),
    ...
    def test_password_salts_are_random(self):
        user_one = User.create_one(username=fake.name(),
                                   email=fake.email(), password='123456')
        user_two = User.create_one(username=fake.name(),
                                   email=fake.email(), password='123456')
        self.assertFalse(user_one.password_hash == user_two.password_hash)

    def test_auth_token_check(self):
        user_one = User.create_one(username="user_one",
                                   email=fake.email(), password='123456')
    ...
    def test_user_role(self):
        admin_user = User.create_one(username="user_two",
                                     email=current_app.config['ADMIN_EMAIL'], password='123456')
        user = User.create_one(username="user_one",
                               email=fake.email(), password='123456')
    ...
    def test_username_and_email_unique(self):
        ...
        user_two = User.create_one(username="user_one",
                                   email='email@email.com', password='123456')
    ...
    def test_follows(self):
        ...
        user_two = User.create_one(username="user_two",
    ...
    def test_create_celebrity(self):
        celebrity_one = Celebrity.create_one(name='成龙', gender=GenderType.MALE,
                                             avatar_url_last='backiee-1119391e8a393275e47b82.jpg', douban_id='1',
                                             imdb_id='imdb1', born_place='HonKong', name_en='ChengLong',
                                             aka_list=['a', 'aa', 'aaa'], aka_en_list=['A', 'AA', 'AAA'])

        db.session.add(celebrity_one)
        db.session.commit()
        celebrity_two = Celebrity.create_one(name='成龙', gender=GenderType.MALE,
                                             avatar_url_last='backiee-1119391e8a393275e47b82.jpg', douban_id='1',
                                             imdb_id='imdb1', born_place='HonKong', name_en='ChengLong',
                                             aka_list=['a', 'aa', 'aaa'], aka_en_list=['A', 'AA', 'AAA'])
        ...
        self.assertEqual(celebrity_one.avatar_url,
    ...
    def test_create_and_delete_movie(self):
        celebrity_one = Celebrity.create_one(name='成龙', gender=GenderType.MALE,
                                             ...
                                             aka_list=['a', 'aa', 'aaa'], aka_en_list=['A', 'AA', 'AAA'])
        celebrity_two = Celebrity.create_one(name='成龙', gender=GenderType.MALE,
                                             avatar_url_last='backiee-1119391e8a393275e47b82.jpg', douban_id='2',
                                             imdb_id='imdb2', born_place='HonKong', name_en='ChengLong',
                                             aka_list=['a', 'aa', 'aaa'], aka_en_list=['A', 'AA', 'AAA'])

        movie_one = Movie.create_one(title='当幸福来敲门', subtype=MovieType.MOVIE,
                                     image_url_last='backiee-1119391e8a393275e47b82.jpg', year=2006, douban_id=1,
                                     imdb_id='imdb2', original_title='dang xingfu lai qiaomen', seasons_count=1,
                                     episodes_count=1, current_season=1, summary="Good",
                                     cinema_status=MovieCinemaStatus.FINISHED, aka_list=['a', 'b', 'c'],
                                     genres_name=['励志', '美国'], countries_name=['美国', '英国'],
                                     directors_obj=[celebrity_one], celebrities_obj=[celebrity_two])
        db.session.add(movie_one)
        db.session.commit()
        self.assertEqual(movie_one.image_url,
    ...
    def test_rating(self):
        ...
        movie_one = Movie.create_one(title='当幸福来敲门', subtype=MovieType.TV,
                                     image_url_last='backiee-1119391e8a393275e47b82.jpg', year=2006, douban_id=1,
                                     imdb_id='imdb2', original_title='dang xingfu lai qiaomen', seasons_count=1,
                                     episodes_count=1, current_season=1, summary="Good",
                                     cinema_status=MovieCinemaStatus.FINISHED, aka_list=['a', 'b', 'c'],
        ...
        user_two = User.create_one(username="user_two",
                                   email=fake.email(), password='123456')
        user_three = User.create_one(username="user_three",
                                     email=fake.email(), password='123456')
