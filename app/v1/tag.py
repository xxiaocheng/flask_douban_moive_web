...
class Tags(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            return {"message": "add tag successfuly"}
        except:
            return {"message": "tag already exist"}, 403
    ...
    def get(self):
        parser = reqparse.RequestParser()
        parser.add_argument(
            "cate", choices=["sys", "user"], default="sys", type=str, location="args"
        )
        args = parser.parse_args()
...
class Country(Resource):
    ...
    def get(self):
        ...
        return {"items": countries, "count": len(countries)}
...
class Year(Resource):
    ...
    def get(self):
        ...
        return {"items": year, "count": len(year)}
